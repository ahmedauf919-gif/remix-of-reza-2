...
const NARRATION: readonly string[] = [
  ...
  "TAQA builds and owns the complete desalination chain, starting with intake and pre-treatment of seawater or brackish water, then reverse-osmosis membranes that strip out salt and impurities, followed by remineralization to potable standard. Treated water is stored, pumped and distributed to the community through smart meters, with TAQA operating the plant and guaranteeing both output volume and quality — all financed under a BOO or BOOT model so the community pays only for the water it actually uses.",
