...
import { capacityExceedances } from "@/data/nabq/clientsData";
import {
  BarChart,
  Bar,
  XAxis,
...
const allData = [...capacityExceedances]
  .map((c) => ({
    name: c.name,
    fullName: c.name,
...
export function CapacityExceedanceChart() {
  ...
  return (
    <div className="glass-card p-6">
      <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h3 className="mb-1 text-lg font-semibold">Capacity Exceedance 2025</h3>
